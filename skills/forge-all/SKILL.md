...
# Fullstack Forge adapter: forge-all
...
`../../.fullstack-forge/skills/forge-all/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-all/SKILL.md`. Every resource the playbook references
