---
name: forge-realtime
description: "Inspect WebSocket, SSE, subscription, and presence flows for authorization, lifecycle, ordering, abuse, and recovery."
---

<!-- fullstack-forge:managed-adapter v1 skill=forge-realtime canonical=../../.fullstack-forge/skills/forge-realtime/SKILL.md -->

# Fullstack Forge adapter: forge-realtime
...
`../../.fullstack-forge/skills/forge-realtime/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-realtime/SKILL.md`. Every resource the playbook references
