...
description: "Verify that logs, metrics, traces, events, alerts, and dashboards answer concrete operational questions safely."
---

<!-- fullstack-forge:managed-adapter v1 skill=forge-observability canonical=../../.fullstack-forge/skills/forge-observability/SKILL.md -->

# Fullstack Forge adapter: forge-observability
...
`../../.fullstack-forge/skills/forge-observability/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-observability/SKILL.md`. Every resource the playbook references
