...
<!-- fullstack-forge:managed-adapter v1 skill=forge canonical=../../.fullstack-forge/skills/forge/SKILL.md -->

# Fullstack Forge adapter: forge
...
`.fullstack-forge/skills/forge/SKILL.md`. Every resource the playbook references
