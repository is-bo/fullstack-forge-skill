---
name: forge-code
description: "Find correctness, maintainability, type-safety, error-handling, and dead-code risks in changed and critical paths."
---

<!-- fullstack-forge:managed-adapter v1 skill=forge-code canonical=../../.fullstack-forge/skills/forge-code/SKILL.md -->

# Fullstack Forge adapter: forge-code
...
`../../.fullstack-forge/skills/forge-code/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-code/SKILL.md`. Every resource the playbook references
