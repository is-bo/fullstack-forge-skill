---
name: forge-realtime
description: Inspect WebSocket, SSE, subscription, and presence flows for authorization, lifecycle, ordering, abuse, and recovery. Use for websockets, sse, subscriptions, live presence, or collaborative state.
---
...
Use this module when a request names `forge-realtime`, asks about realtime communication, or
...
Use IDs `FF-REAL-001`, `FF-REAL-002`, and so on. Preserve an ID across
