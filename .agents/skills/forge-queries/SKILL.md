...
<!-- fullstack-forge:managed-adapter v1 skill=forge-queries canonical=../../../.fullstack-forge/skills/forge-queries/SKILL.md -->

# Fullstack Forge adapter: forge-queries
...
`../../../.fullstack-forge/skills/forge-queries/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-queries/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js queries compose --root <repository-root> --json`
