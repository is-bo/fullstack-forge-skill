...
<!-- fullstack-forge:managed-adapter v1 skill=forge-uploads canonical=../../../.fullstack-forge/skills/forge-uploads/SKILL.md -->

# Fullstack Forge adapter: forge-uploads
...
`../../../.fullstack-forge/skills/forge-uploads/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-uploads/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js uploads compose --root <repository-root> --json`
