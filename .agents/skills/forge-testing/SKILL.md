---
name: forge-testing
description: "Evaluate whether tests provide reliable risk-based evidence across units, boundaries, workflows, and failure modes."
---

<!-- fullstack-forge:managed-adapter v1 skill=forge-testing canonical=../../../.fullstack-forge/skills/forge-testing/SKILL.md -->

# Fullstack Forge adapter: forge-testing
...
`../../../.fullstack-forge/skills/forge-testing/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-testing/SKILL.md`. Every resource the playbook references
