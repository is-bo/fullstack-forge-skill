---
name: forge-database
description: "Inspect schema integrity, migrations, constraints, tenancy, lifecycle, recovery, and production-safe evolution."
---

<!-- fullstack-forge:managed-adapter v1 skill=forge-database canonical=../../../.fullstack-forge/skills/forge-database/SKILL.md -->

# Fullstack Forge adapter: forge-database
...
`../../../.fullstack-forge/skills/forge-database/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-database/SKILL.md`. Every resource the playbook references
