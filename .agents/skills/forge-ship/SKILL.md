...
<!-- fullstack-forge:managed-adapter v1 skill=forge-ship canonical=../../../.fullstack-forge/skills/forge-ship/SKILL.md -->

# Fullstack Forge adapter: forge-ship
...
`.fullstack-forge/skills/forge-ship/SKILL.md`. Every resource the playbook references
