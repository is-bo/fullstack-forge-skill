...
<!-- fullstack-forge:managed-adapter v1 skill=forge-new canonical=../../../.fullstack-forge/skills/forge-new/SKILL.md -->

# Fullstack Forge adapter: forge-new
...
`../../../.fullstack-forge/skills/forge-new/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-new/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js new compose --root <repository-root> --json`
