...
<!-- fullstack-forge:managed-adapter v1 skill=forge-analytics canonical=../../../.fullstack-forge/skills/forge-analytics/SKILL.md -->

# Fullstack Forge adapter: forge-analytics
...
`../../../.fullstack-forge/skills/forge-analytics/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-analytics/SKILL.md`. Every resource the playbook references
