...
<!-- fullstack-forge:managed-adapter v1 skill=forge-feature canonical=../../../.fullstack-forge/skills/forge-feature/SKILL.md -->

# Fullstack Forge adapter: forge-feature
...
`../../../.fullstack-forge/skills/forge-feature/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-feature/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js feature compose --root <repository-root> --json`
