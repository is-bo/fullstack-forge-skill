...
<!-- fullstack-forge:managed-adapter v1 skill=forge-performance canonical=../../../.fullstack-forge/skills/forge-performance/SKILL.md -->

# Fullstack Forge adapter: forge-performance
...
`../../../.fullstack-forge/skills/forge-performance/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-performance/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js performance compose --root <repository-root> --json`
