---
name: forge-storage
description: "Inspect object naming, access control, encryption, lifecycle, consistency, integrity, and recovery."
---

<!-- fullstack-forge:managed-adapter v1 skill=forge-storage canonical=../../../.fullstack-forge/skills/forge-storage/SKILL.md -->

# Fullstack Forge adapter: forge-storage
...
`../../../.fullstack-forge/skills/forge-storage/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-storage/SKILL.md`. Every resource the playbook references
