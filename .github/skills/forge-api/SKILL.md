...
<!-- fullstack-forge:managed-adapter v1 skill=forge-api canonical=../../../.fullstack-forge/skills/forge-api/SKILL.md -->

# Fullstack Forge adapter: forge-api
...
`../../../.fullstack-forge/skills/forge-api/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-api/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js api compose --root <repository-root> --json`
