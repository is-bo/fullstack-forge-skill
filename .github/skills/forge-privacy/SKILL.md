...
<!-- fullstack-forge:managed-adapter v1 skill=forge-privacy canonical=../../../.fullstack-forge/skills/forge-privacy/SKILL.md -->

# Fullstack Forge adapter: forge-privacy
...
`../../../.fullstack-forge/skills/forge-privacy/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-privacy/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js privacy compose --root <repository-root> --json`
