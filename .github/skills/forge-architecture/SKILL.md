...
<!-- fullstack-forge:managed-adapter v1 skill=forge-architecture canonical=../../../.fullstack-forge/skills/forge-architecture/SKILL.md -->

# Fullstack Forge adapter: forge-architecture
...
`../../../.fullstack-forge/skills/forge-architecture/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-architecture/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js architecture compose --root <repository-root> --json`
