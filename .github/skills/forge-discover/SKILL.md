...
<!-- fullstack-forge:managed-adapter v1 skill=forge-discover canonical=../../../.fullstack-forge/skills/forge-discover/SKILL.md -->

# Fullstack Forge adapter: forge-discover
...
`../../../.fullstack-forge/skills/forge-discover/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-discover/SKILL.md`. Every resource the playbook references
