 ...
 * itself. Those two directories are therefore copied verbatim into their generic host trees and
 * the package-local Codex plugin root. Every other host consumes only `SKILL.md`, so every other
 * host gets adapters alone.
 */
export const VERBATIM_HOST_IDS = Object.freeze(["agents", "antigravity", "codex-plugin"]);
