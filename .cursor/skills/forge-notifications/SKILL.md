...
<!-- fullstack-forge:managed-adapter v1 skill=forge-notifications canonical=../../../.fullstack-forge/skills/forge-notifications/SKILL.md -->

# Fullstack Forge adapter: forge-notifications
...
`../../../.fullstack-forge/skills/forge-notifications/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-notifications/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js notifications compose --root <repository-root> --json`
