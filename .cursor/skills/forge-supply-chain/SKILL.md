...
<!-- fullstack-forge:managed-adapter v1 skill=forge-supply-chain canonical=../../../.fullstack-forge/skills/forge-supply-chain/SKILL.md -->

# Fullstack Forge adapter: forge-supply-chain
...
`../../../.fullstack-forge/skills/forge-supply-chain/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-supply-chain/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js supply-chain compose --root <repository-root> --json`
