...
<!-- fullstack-forge:managed-adapter v1 skill=forge-seo canonical=../../../.fullstack-forge/skills/forge-seo/SKILL.md -->

# Fullstack Forge adapter: forge-seo
...
`../../../.fullstack-forge/skills/forge-seo/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-seo/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js seo compose --root <repository-root> --json`
