...
<!-- fullstack-forge:managed-adapter v1 skill=forge-deployment canonical=../../../.fullstack-forge/skills/forge-deployment/SKILL.md -->

# Fullstack Forge adapter: forge-deployment
...
`../../../.fullstack-forge/skills/forge-deployment/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-deployment/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js deployment compose --root <repository-root> --json`
