...
<!-- fullstack-forge:managed-adapter v1 skill=forge-i18n canonical=../../../.fullstack-forge/skills/forge-i18n/SKILL.md -->

# Fullstack Forge adapter: forge-i18n
...
`../../../.fullstack-forge/skills/forge-i18n/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-i18n/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js i18n compose --root <repository-root> --json`
