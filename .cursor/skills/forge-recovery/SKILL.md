...
<!-- fullstack-forge:managed-adapter v1 skill=forge-recovery canonical=../../../.fullstack-forge/skills/forge-recovery/SKILL.md -->

# Fullstack Forge adapter: forge-recovery
...
`../../../.fullstack-forge/skills/forge-recovery/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-recovery/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js recovery compose --root <repository-root> --json`
