...
import { classifyCommandNetworkPolicy, decideCommandExecution, ledgerRecord, plannedCheckNetworkPolicy } from "../src/offline-policy.js";
...
test("a blocked command cannot be converted into PASS runtime evidence", () => {
    ...
    assert.throws(() => appendRuntimeEvidence(ledger, { ...evidence, status: "PASS" }), /cannot be re-recorded as PASS/u);
});
