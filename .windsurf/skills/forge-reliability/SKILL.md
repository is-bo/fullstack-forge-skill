...
<!-- fullstack-forge:managed-adapter v1 skill=forge-reliability canonical=../../../.fullstack-forge/skills/forge-reliability/SKILL.md -->

# Fullstack Forge adapter: forge-reliability
...
`../../../.fullstack-forge/skills/forge-reliability/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-reliability/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js reliability compose --root <repository-root> --json`
