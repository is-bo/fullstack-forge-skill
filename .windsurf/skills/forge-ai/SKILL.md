---
name: forge-ai
description: "Audit model boundaries, prompt injection, tool authority, data handling, output validation, evaluation, fallback, and cost."
---

<!-- fullstack-forge:managed-adapter v1 skill=forge-ai canonical=../../../.fullstack-forge/skills/forge-ai/SKILL.md -->

# Fullstack Forge adapter: forge-ai
...
`../../../.fullstack-forge/skills/forge-ai/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-ai/SKILL.md`. Every resource the playbook references
