...
<!-- fullstack-forge:managed-adapter v1 skill=forge-docs canonical=../../../.fullstack-forge/skills/forge-docs/SKILL.md -->

# Fullstack Forge adapter: forge-docs
...
`../../../.fullstack-forge/skills/forge-docs/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-docs/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js docs compose --root <repository-root> --json`
