...
<!-- fullstack-forge:managed-adapter v1 skill=forge-infrastructure canonical=../../../.fullstack-forge/skills/forge-infrastructure/SKILL.md -->

# Fullstack Forge adapter: forge-infrastructure
...
`../../../.fullstack-forge/skills/forge-infrastructure/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-infrastructure/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js infrastructure compose --root <repository-root> --json`
