...
<!-- fullstack-forge:managed-adapter v1 skill=forge-integrations canonical=../../../.fullstack-forge/skills/forge-integrations/SKILL.md -->

# Fullstack Forge adapter: forge-integrations
...
`../../../.fullstack-forge/skills/forge-integrations/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-integrations/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js integrations compose --root <repository-root> --json`
