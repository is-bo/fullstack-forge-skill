...
<!-- fullstack-forge:managed-adapter v1 skill=forge-ux canonical=../../../.fullstack-forge/skills/forge-ux/SKILL.md -->

# Fullstack Forge adapter: forge-ux
...
`../../../.fullstack-forge/skills/forge-ux/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-ux/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js ux compose --root <repository-root> --json`
