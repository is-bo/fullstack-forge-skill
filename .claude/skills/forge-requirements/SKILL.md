...
<!-- fullstack-forge:managed-adapter v1 skill=forge-requirements canonical=../../../.fullstack-forge/skills/forge-requirements/SKILL.md -->

# Fullstack Forge adapter: forge-requirements
...
`../../../.fullstack-forge/skills/forge-requirements/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-requirements/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js requirements compose --root <repository-root> --json`
