---
name: forge-tenancy
description: "Verify tenant context propagation and isolation across data, cache, files, jobs, search, analytics, and administration."
---
...
`node "<resolved-absolute-runner-path>" tenancy compose --workflow audit --root "<repository-root>" --dry-run --json`
