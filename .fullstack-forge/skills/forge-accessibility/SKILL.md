...
description: "Use automatically for human-facing interface work and audit WCAG 2.2 AA with automated evidence plus keyboard and assistive-technology reasoning."
---
...
`node "<resolved-absolute-runner-path>" accessibility compose --workflow audit --root "<repository-root>" --dry-run --json`
