...
- **Suggested command**: Which command to use (prefer: $forge ui adapt, $forge ui animate, $forge ui audit, $forge ui bolder, $forge ui clarify, $forge ui colorize, $forge ui critique, $forge ui delight, $forge ui distill, $forge ui document, $forge ui harden, $forge ui layout, $forge ui onboard, $forge ui optimize, $forge ui overdrive, $forge ui polish, $forge ui quieter, $forge ui shape, $forge ui typeset)
...
**Rules**: Only recommend commands from: $forge ui adapt, $forge ui animate, $forge ui audit, $forge ui bolder, $forge ui clarify, $forge ui colorize, $forge ui critique, $forge ui delight, $forge ui distill, $forge ui document, $forge ui harden, $forge ui layout, $forge ui onboard, $forge ui optimize, $forge ui overdrive, $forge ui polish, $forge ui quieter, $forge ui shape, $forge ui typeset. Map findings to the most appropriate command. End with `$forge ui polish` as the final step if any fixes were recommended.

After presenting the summary, tell the user:

> You can ask me to run these one at a time, all at once, or in any order you prefer.
>
> Re-run `$forge ui audit` after fixes to see your score improve.
