...
Acceptance criteria are per-task and answer "did we build the right thing?". They sit on top of the project-wide Definition of Done, the standing bar every task clears before it counts as done. See `.fullstack-forge/upstream/addy-agent-skills/references/definition-of-done.md`.
