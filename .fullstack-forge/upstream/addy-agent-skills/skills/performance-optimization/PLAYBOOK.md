...
For detailed performance checklists, optimization commands, and anti-pattern reference, see `.fullstack-forge/upstream/addy-agent-skills/references/performance-checklist.md`.
