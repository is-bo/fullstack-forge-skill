# Fullstack Forge v0.3.0 release verification
...
This record describes the locally validated v0.3.0 candidate. It does not claim a GitHub Release,
...
- [ ] annotated `v0.3.0` tag bound to the verified merge commit
...
- Local candidate validation passed on Windows with Node.js 24.14.1; hosted cross-platform evidence
  remains pending.
...
- npm registry publication is `NOT_VERIFIED`; v0.3.0 is unpublished and publication is unconfigured.
