...
- **Documentation**: `docs/RELEASING.md`, `docs/RELEASE_NOTES_v0.3.0.md`
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.0.md`
- **Pending integration**: _none_
- **Limitations**: v0.3.0 remote CI, publication, immutable assets, and downloaded-byte evidence are pending; npm publication is separate, unconfigured, and unavailable.
...
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.0.md`
- **Pending integration**: _none_
- **Limitations**: The v0.3.0 release is not published, so installation from its remote immutable artifacts cannot yet be exercised or recorded.
...
- **Tests**: `scripts/tests/release-safety.test.mjs`
- **Documentation**: `docs/RELEASE.md`, `docs/RELEASE_NOTES_v0.3.0.md`
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.0.md`
- **Pending integration**: _none_
- **Limitations**: The final v0.3.0 closing record depends on remote workflow, release, asset, and attestation evidence that does not yet exist.
