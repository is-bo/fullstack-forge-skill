...
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.1.md`
...
- **Documentation**: `docs/BUILD_MODE.md`, `docs/RELEASE_NOTES_v0.3.1.md`
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.1.md`
- **Pending integration**: _none_
...
Distribution archives contain real files, exclude dependencies, temporary material, and secrets, install from a clean directory, are deterministic, and ship with an exact npm artifact, SPDX SBOM, and checksums.

- **Status**: COMPLIANT
- **Implementation**: `scripts/package-platforms.mjs`, `scripts/validate-dist.mjs`, `scripts/lib/package-policy.mjs`, `scripts/lib/release-bundle.mjs`, `scripts/lib/zip.mjs`, `scripts/smoke-install.mjs`, `scripts/offline-install.mjs`
- **Tests**: `scripts/tests/zip.test.mjs`, `scripts/tests/smoke-install.test.mjs`, `scripts/tests/package-policy.test.mjs`, `scripts/tests/release-bundle.test.mjs`
...
The Codex package exposes version-locked plugin and marketplace metadata plus generated thin adapters that resolve the same canonical managed playbook tree as every other host.

- **Status**: PARTIALLY_COMPLIANT
- **Implementation**: `.codex-plugin/plugin.json`, `.agents/plugins/marketplace.json`, `scripts/check-codex-plugin.mjs`, `scripts/project.mjs`
- **Tests**: `scripts/tests/codex-plugin.test.mjs`
- **Documentation**: `README.md`, `docs/GETTING_STARTED.md`
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.1.md`
- **Pending integration**: _none_
- **Limitations**: The local plugin package is validated, but its npm-backed marketplace entry is unavailable until a separate npm publication is authorized and directly observed.
...
- **Documentation**: `docs/GETTING_STARTED.md`, `docs/TROUBLESHOOTING.md`, `docs/PLATFORM_SUPPORT.md`, `docs/RELEASE_CHANNEL.md`
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.1.md`
- **Pending integration**: _none_
...
- **Status**: COMPLIANT
- **Implementation**: `package.json`, `scripts/validate-skill.mjs`, `scripts/validate-dist.mjs`, `scripts/release-preflight.mjs`, `scripts/lib/package-policy.mjs`, `scripts/lib/release-bundle.mjs`, `scripts/verify-required-workflows.mjs`
- **Tests**: `scripts/tests/release-safety.test.mjs`, `scripts/tests/release-bundle.test.mjs`, `scripts/tests/required-workflows.test.mjs`, `scripts/tests/smoke-install.test.mjs`
...
- **Status**: NOT_VERIFIED (external)
- **Implementation**: `scripts/verify-published-assets.mjs`, `scripts/release-preflight.mjs`, `scripts/generate-final-verification.mjs`, `scripts/verify-required-workflows.mjs`
- **Tests**: `scripts/tests/release-safety.test.mjs`, `scripts/tests/required-workflows.test.mjs`
- **Documentation**: `docs/RELEASING.md`, `docs/RELEASE_NOTES_v0.3.1.md`
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.1.md`
- **Pending integration**: _none_
- **Limitations**: v0.3.1 remote CI, publication, immutable assets, and downloaded-byte evidence are pending; npm publication is separate, unconfigured, and unavailable.
...
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.1.md`
- **Pending integration**: _none_
- **Limitations**: The v0.3.1 release is not published, so installation from its remote immutable artifacts cannot yet be exercised or recorded.
...
- **Tests**: `scripts/tests/release-safety.test.mjs`
- **Documentation**: `docs/RELEASE.md`, `docs/RELEASE_NOTES_v0.3.1.md`
- **Release verification**: `docs/RELEASE_VERIFICATION_v0.3.1.md`
- **Pending integration**: _none_
- **Limitations**: The final v0.3.1 closing record depends on remote workflow, release, asset, and attestation evidence that does not yet exist.
