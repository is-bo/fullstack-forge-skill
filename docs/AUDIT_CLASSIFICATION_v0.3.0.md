...
| DEV-007 | Build state had no explicit, safe compatibility path from v0.2 schema v1.                                         | FIXED          | `cli/src/build-migration.ts`, `cli/tests/build-migration.test.ts`                                                   | Migration is operator-triggered and refuses mixed, malformed, changed, or unsafe state.                           |
