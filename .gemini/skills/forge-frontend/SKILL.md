...
<!-- fullstack-forge:managed-adapter v1 skill=forge-frontend canonical=../../../.fullstack-forge/skills/forge-frontend/SKILL.md -->

# Fullstack Forge adapter: forge-frontend
...
`../../../.fullstack-forge/skills/forge-frontend/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-frontend/SKILL.md`. Every resource the playbook references
