---
name: forge-api
description: Audit API contracts, boundary validation, authorization, consistency, pagination, errors, and idempotency. Use for http, graphql, rpc, or event-consumed application interfaces.
---
...
Use IDs `FF-API-001`, `FF-API-002`, and so on. Preserve an ID across
