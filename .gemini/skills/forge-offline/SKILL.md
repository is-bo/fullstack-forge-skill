...
<!-- fullstack-forge:managed-adapter v1 skill=forge-offline canonical=../../../.fullstack-forge/skills/forge-offline/SKILL.md -->

# Fullstack Forge adapter: forge-offline
...
`../../../.fullstack-forge/skills/forge-offline/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-offline/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js offline compose --root <repository-root> --json`
