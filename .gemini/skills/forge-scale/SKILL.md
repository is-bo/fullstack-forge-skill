...
# Fullstack Forge adapter: forge-scale
...
`../../../.fullstack-forge/skills/forge-scale/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-scale/SKILL.md`. Every resource the playbook references
