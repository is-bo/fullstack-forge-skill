---
name: forge-tenancy
description: Verify tenant context propagation and isolation across data, cache, files, jobs, search, analytics, and administration. Use for shared applications serving distinct organizations or customer partitions.
---
...
Use this module when a request names `forge-tenancy`, asks about multi-tenancy, or
...
Use IDs `FF-TENA-001`, `FF-TENA-002`, and so on. Preserve an ID across
