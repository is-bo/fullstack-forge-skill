...
<!-- fullstack-forge:managed-adapter v1 skill=forge-auth canonical=../../../.fullstack-forge/skills/forge-auth/SKILL.md -->

# Fullstack Forge adapter: forge-auth
...
`../../../.fullstack-forge/skills/forge-auth/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-auth/SKILL.md`. Every resource the playbook references
...
`node ../../../.fullstack-forge/runtime/cli/src/composition-entry.js auth compose --root <repository-root> --json`
