...
<!-- fullstack-forge:managed-adapter v1 skill=forge-cost canonical=../../../.fullstack-forge/skills/forge-cost/SKILL.md -->

# Fullstack Forge adapter: forge-cost
...
`../../../.fullstack-forge/skills/forge-cost/SKILL.md`

That path is relative to this file. From the installation root it is
`.fullstack-forge/skills/forge-cost/SKILL.md`. Every resource the playbook references
