...
export const PROJECT_INSTRUCTIONS: Readonly<Partial<Record<Platform, ProjectInstruction>>> = {
...
export function extractManagedSection(content: string): string | undefined {
...
export function upsertManagedSection(current: string, next: string): string {
