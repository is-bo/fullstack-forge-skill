...
const scenarios: Scenario[] = [
  ...
  {
    request:
      "Review the React admin interface user flow, visual design, accessibility, permissions, and sensitive data handling",
